    ...
    $(function () {
        ...
        'customerMobility': function(){
            ...
            'pdpReadMore': function () {
                var readMore = $('.pdp-readmore');
                if(readMore.length){
                    readMore.on('click',function(){
                        var accordion = $('.accordion-product');
                        accordion.find('li').removeClass('active');
                        accordion.find('li').find('.content').removeClass('active');
                        accordion.find('.product-information').addClass('active');
                        accordion.find('li.product-information').find('.content').addClass('active');
                    });
                }
            },
            'init': function () {
