        ...
        var beauComponents = {
            ...
            'wheelFinder': {
                ...
                '_setViewDeatilsUrl': function() {
                  ...
                  $('.product-item .view-detials').attr('href', activeSize.attr('data-url'));
                },
                    ...
                    if ($this.wheelItems.length) {
                        ...
                        $.each(data.VehicleImages, function (key, imageData) {
                            ...
                            var colourElem = $('<li/>', {
                                ...
                                css: {
                                    'background-color': '#' + imageData.Colour.HexValue
                                },
                                click: function () {
                            ...
                            $.each(option, function () {
                                ...
                                selectSizeElem.append(
                                    $('<option />')
                                        ...
                                        .attr('selected', getLowest(size.IsLowest))
                                        .val(size.Id)
                                );
                            });
                        };
            ...
            'productPricing': {
                ...
                'setConst': function ($cart) {
                    ...
                    this.const = {
                        ...
                        '$stockMessage': $('.stock-msg'),
                        '$callForStockButton': $('.call-for-stock'),
                        '$requestPriceButton': $('.request-price'),
                        '$bookFittingButton': $('.book-fitting'),
                ...
                'updateSizes': function ($field) {
                    ...
                    var getPrice = function (dataName) {
                        ...
                        if ($dataElem.length) {
                            price = $dataElem.data(dataName) + $this.const.showPriceSuffix;
                        } else {
                    ...
                    var getPrice = function (dataName) {
                        ...
                        if (dataName === 'rrp-price' && price !== 'N/A') {
                            ...
                            price += $this.const.showPriceSuffix;
                        }
                    ...
                    var formatPriceSuffix = function (price) {
                        ...
                        console.log('price: ', $this.PDPType, price);
                    ...
                    var updateQty = function(dataName){
                        ...
                        if ($dataElem.length) {
                            ...
                            $this.const.$selectQtys.find('option').remove();
                            if(qty > 0){
                                if(qty > 6){
                                    qty = 6;
                                }
                                for(var i = 1; i<=qty;i++){
                                    $this.const.$selectQtys.append($("<option></option>")
                                        .attr("value",i)
                                        .text(i));
                                }
                            }else{
                ...
                'updateAddToCart': function () {
                    ...
                    // private function: disable/enable Add To Cart button
                    var enableButton = function (isDisabled) {
                        //  $this.const.$addToCartButton.prop('disabled', isDisabled);
                        //  See BCC-201 hide the Add to Cart button if Price is not available for a product
                        $this.const.$addToCartButton.toggle(isDisabled);
                        $this.const.$callForStockButton.toggle(!isDisabled);
                    }

                    // private function: disable/enable book fitting and request price
                    var disableButton = function(isDisabled){
                        $this.const.$requestPriceButton.toggle(isDisabled);
                        $this.const.$bookFittingButton.toggle(isDisabled);
                    }
                    ...
                    if (frontIsEligibleToCartBtn && rearIsEligibleToCartBtn) {
                        ...
                        $this.const.$addToCartButton.show();
                        $this.const.$callForStockButton.hide();
                        $this.const.$requestPriceButton.hide();
                        $this.const.$bookFittingButton.hide();
                        ...
                        if (frontIsEligibleToRequestPriceBtn || rearIsEligibleToRequestPriceBtn) {
                            $this.const.$addToCartButton.show();
                            $this.const.$callForStockButton.show();
                            $this.const.$requestPriceButton.show();
                            $this.const.$bookFittingButton.show();
                        } else {
                            $this.const.$addToCartButton.show();
                            $this.const.$callForStockButton.hide();
                            $this.const.$requestPriceButton.hide();
                        ...
                        if (frontIsEligibleToRequestPriceBtn || rearIsEligibleToRequestPriceBtn) {
                            ...
                            $this.const.$requestPriceButton.show();
                            $this.const.$bookFittingButton.show();
                            $cartTotal.hide() // BCC-500 - hide total when total is 0.00
                        } else {
                ...
                'updateSpecificationsTable': function () {
                    ...
                    if ($compatibilityParent.length) {
                        var $superAttributeSelect = $('.super-attribute-select'),
                            ...
                            $frontSizeDropDown = $('.cart-component #wheel-front'),
                            $rearSizeDropDown = $('.cart-component #wheel-rear'),
                        ...
                        if (isActive) {
                            $matchedContainer.text($sizeText);
                ...
                'writeSpecTable': function () {
                    ...
                    // move back to DOM
                    $this.const.$specsTable.prependTo($tableParent);
                },
            },
