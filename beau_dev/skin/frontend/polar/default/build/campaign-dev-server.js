...
console.log('Staring up campaign dev');

console.log('process.env.URL', process.env.name);
...
console.log('Campaign: ' + process.env.name);
...
var webpackConfig = require('./webpack.campaign.dev.conf')
