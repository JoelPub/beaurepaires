(function ($) {
  ...
  Menu.prototype = {
    ...
    _createIconSelect: function (item) {
      ...
      $icon.children('.wPaint-menu-icon-img').text(_this.wPaint.options[item.name]);
    ...
    _createIconColorpicker: function (item) {
      ...
      $icon.children('.wPaint-menu-icon-img').css('backgroundColor',_this.wPaint.options[item.name]);
      return $icon;
    },
