    ...
    public function geolock() {
        ...
        if (Mage::app()->getStore()->isAdmin()) {
            ...
            if ($isDenied === true) {
                ...
                # log when access has been denied so we have some record of attempts.
                $currentUrl = Mage::helper('core/url')->getCurrentUrl();
                Mage::log("Attempted access to $currentUrl from IP $customerIp from country $customerCountryCode",null, 'access_denied.log');
...
<p>
    You have not been authorised to by the Website Administrator
    to access this site. Please email <a href="mailto:onlinesales@beaurepaires.com.au">onlinesales@beaurepaires.com.au</a>
</p>
</body>
</html>
HTML;
