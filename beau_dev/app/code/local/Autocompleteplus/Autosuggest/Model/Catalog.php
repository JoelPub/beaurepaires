                ...
                if($attr->getfrontend_input()=='select'){
                    if($productModel->getData($action)){
                        if (method_exists($productModel, 'getAttributeText')){
                            $row.='<attribute is_filterable="'.$is_filterable.'" name="'.$attr->getAttributeCode().'"><![CDATA['.$productModel->getAttributeText($action).']]></attribute>';
                        } else {
                            $row.='<attribute is_filterable="'.$is_filterable.'" name="'.$attr->getAttributeCode().'"><![CDATA['.$productModel->getData($action).']]></attribute>';
                        }
                    }
        ...
        try{
            ...
            foreach ($productAttributeOptions as $productAttribute) {
                ...
                foreach ($productAttribute['values'] as $attribute) {
                    ...
                    $attributeOptions[$productAttribute['label']]['values'][] = $attribute['store_label'];

                }



                $attributeOptions[$productAttribute['label']]['is_filterable']=$attributeFull['is_filterable'];



                $attributeOptions[$productAttribute['label']]['frontend_input']=$attributeFull['frontend_input'];
