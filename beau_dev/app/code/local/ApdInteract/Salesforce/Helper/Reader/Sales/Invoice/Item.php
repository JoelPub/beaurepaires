...
class ApdInteract_Salesforce_Helper_Reader_Sales_Invoice_Item 
extends ApdInteract_Salesforce_Helper_Core_Reader_Abstract {
	
	public function __construct() {
		$this->model_name = "sales/order_invoice_item";
		parent::__construct();
	}
	...
	public function getAllSyncedOrderIds() {
	    $start = mktime(0,0,0,date('m'), date('d'), date('Y'));;
            ...
            $class = get_class(Mage::getModel("sales/order_invoice"));
            
            $dc = Mage::getModel("sales/order_invoice")
                ->getCollection();
