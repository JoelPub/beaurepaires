<?php class ApdInteract_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('simple_action', 'select', array(
            ...
            'options'    => array(
                ...
                ApdInteract_SalesRule_Model_Rule::BUNDLED_PRICE_ACTION => Mage::helper('salesrule')->__('Bundled Price for selected items'), 
            ),
        ));
