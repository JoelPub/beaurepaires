<?php
class ApdInteract_Vir_Block_Autocomplete extends Mage_Core_Block_Template {
    ...
    public function getAutocompleteCustomers() {
        ...
        $orders = $this->getOrderCollection($search['custname']);        
        return $orders;
...
//                 'custpostcode'=>'soa.postcode' 
        ...
        $orders->getSelect()
            ...
            ->columns(array(
                ...
                'UPPER(registration_number) AS vehiclerego',
                'odometer AS vehicleodometer'                
                ))
//            ->group('name')
