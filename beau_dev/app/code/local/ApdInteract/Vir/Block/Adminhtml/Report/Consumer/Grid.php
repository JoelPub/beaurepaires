<?php
class ApdInteract_Vir_Block_Adminhtml_Report_Consumer_Grid extends Mage_Adminhtml_Block_Widget_Grid{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel('apdinteract_vir/order_collection')
                    ->addFieldToSelect(array('invoiceno','custname','vehiclemodel'));
        // Filter created date
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('vehiclemodel', array(
            'header' => $this->_getHelper()->__('Vehicle Model'),
            'type' => 'text',
            'index' => 'vehiclemodel',
            'sortable'      => false,
            'filter' => false,
        ...
        $this->addExportType('*/*/exportReportConsumerCsv', Mage::helper('adminhtml')->__('CSV'));
