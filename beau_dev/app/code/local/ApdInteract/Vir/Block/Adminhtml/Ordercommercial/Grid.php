...
class ApdInteract_Vir_Block_Adminhtml_Ordercommercial_Grid extends Mage_Adminhtml_Block_Widget_Grid {

    protected function _prepareCollection() {
        /**
         * Tell Magento which collection to use to display in the grid.
         */
        $collection = Mage::getResourceModel('apdinteract_vir/ordercommercial_collection')->setOrder('parent_id', 'DESC');
...
//        $sql = (string)$collection->getSelect();
    ...
    public function getRowUrl($row) {
         ...
         * OrdercommercialController.php in VIR module.
         */
        return $this->getUrl(
                        'apdinteract_vir_admin/ordercommercial/edit', array(
                    'id' => $row->getId()
                        )
        );
    }
        ...
        $this->addColumn('print', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url' => array('base' => 'apdinteract_vir_admin/ordercommercial/print'),
                    'field' => 'id'
                ),
            ),
            'filter' => false,
