<?php
class ApdInteract_Vir_Model_Ordercommercial
    extends Mage_Core_Model_Abstract
{
    ...
    protected function _construct()
    {
         ...
         */
        $this->_init('apdinteract_vir/ordercommercial');
    }
    ...
    protected function _beforeSave()
    {
        ...
        /**
         * Perform some actions just before a ordercommercial is saved.
         */
    ...
    protected function _updateTimestamps()
    {
        ...
        /**
         * If we have a ordercommercial new object, set the created timestamp.
         */
        if ($this->isObjectNew()) {
    ...
    protected function addStoreMapping($vir_id,$store_id)
    {
        ...
        $mapping->setVirType(1); //commercial type
        $mapping->save();
    }
