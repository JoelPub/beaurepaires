...
// Get the current requesting users IP address
function getUserIp() {
    if (isset($_SERVER)) {
...
$ip = explode(",", $ip);
$allowedIp = array();
if (file_exists('whitelistIp.php')) {
    include 'whitelistIp.php';
}

if (file_exists($maintenanceFile) && !in_array($ip[0], $allowedIp)) {
