 ...
 */
class ApdInteract_Roundingerrorfix_Model_Calculation extends Mage_Tax_Model_Calculation
{
    /*
   ...
   /* public function calcTaxAmount($price, $taxRate, $priceIncludeTax = false, $round = true)
    {
        ...
        return Parent::calcTaxAmount($price, $taxRate, $priceIncludeTax = false, $round = true);
        $taxRate = $taxRate / 100;
