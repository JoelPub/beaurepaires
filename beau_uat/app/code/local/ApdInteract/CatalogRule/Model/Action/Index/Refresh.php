 ...
 */
class ApdInteract_CatalogRule_Model_Action_Index_Refresh
{
    /**
     * Connection instance
     *
    ...
    /*
     * Run reindex
     * Rewrite this method because for some reason all the catalog price rules are not working anymore the next day
     * See http://stackoverflow.com/questions/25280095/magento-catalog-price-rule-disappears-at-night 
     * BCC - 225 01/06/16
     */
    public function execute()
    {
        ...
        $timestamp1 = $coreDate->gmtTimestamp('Today');
        ...
        Mage::log('BCC 225 changes passed!');
        Mage::log('new timestamp value: ' . $timestamp);
        Mage::log('old timestamp value: ' . $timestamp1);
    }
