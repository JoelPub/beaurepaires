...
class ApdInteract_Adminhtml_Block_Cms_Block_Edit_Form extends Mage_Adminhtml_Block_Cms_Block_Edit_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('customer_group_id', 'select', array(
            ...
            'required'  => false,
            'options'   => $this->_getCustomerGroup(),
        ));
