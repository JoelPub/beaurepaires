<?php
class ApdInteract_Catalog_Block_Layer_Filter_Attribute extends Mage_Catalog_Block_Layer_Filter_Attribute
{
    ...
    /*
     * This method returns the class name of attributes under the Layered Navigation Section - See BCC 310
