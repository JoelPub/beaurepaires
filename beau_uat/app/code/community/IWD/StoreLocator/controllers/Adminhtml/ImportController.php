<?php
class IWD_StoreLocator_Adminhtml_ImportController extends Mage_Adminhtml_Controller_Action{
	...
	public function indexAction(){
		...
		$exampleCsv = $skin . '/frontend/polar/default/import_example.csv';//'http://demo.iwdextensions.com/store-locator/import_example.csv';
		...
		$this->_getSession()->addNotice(                        
				$this->__('<a href="' . $exampleCsv . '">Example of import file</a>')
		);
	...
	public function fillAction(){
		...
		Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('storelocator')->__('Geo Data have been updated successfully.'));
	...
	public function removeallAction(){
		...
		Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('storelocator')->__('Stores have been remove successfully.'));
		$this->_redirect('*/adminhtml_list/index');
