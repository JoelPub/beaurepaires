        ...
        var beauComponents = {
            ...
            'productPricing': {
                ...
                'addToCart': function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            window.incrementBadge('Cart', totalQty);
                        },
                        error: function(res) {
                            $cartLoading.hide();
                ...
                'updateSizes': function ($field) {
                    ...
                    var updateQty = function(dataName){
                        ...
                        if ($dataElem.length) {
                            ...
                            $this.const.$selectQtys.prop('selectedIndex', 1);
                        }
                    }
                ...
                'writeSpecTable': function () {
                    ...
                    //$this.const.$specificationsContainer.append($this.const.$mainSpecificationsTable.html()); // append to all .specification-container
                    //$this.const.$specificationsContainer.empty(); // clear 
                },
