...
Growler = (function(){
	...
	return Class.create({
		...
		,warn: function(msg, options){
			return specialNotice(this.growler, msg, options, "", "#F6BD6F", "#000"); // Warning!
		}
		,error: function(msg, options){
			return specialNotice(this.growler, msg, options, "", "#F66F82", "#000"); // Error!
		}
		,info: function(msg, options){
			return specialNotice(this.growler, msg, options, "", "#BBF66F", "#000"); // Information!
		}
